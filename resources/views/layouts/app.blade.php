...
<div class="top-header">
		<div class="container">
			<div class="top-header-main">
				<div class="col-md-6 top-header-left">
					<div class="drop">
                        <!--giriş yapınca navbara isim yazdırma-->
                        @auth
                        <div class="box">
							<a href="" style="color: white;">{{\Illuminate\Support\Facades\Auth::user()->name}}</a>
						</div>
                        <!--çıkış yapma laravel çıkışı post olarak yapıyor-->
                        <div class="box">
				...
				<div class="col-md-6 top-header-left">
					<div class="cart box_1">
						<a href="{{route('basket.index')}}">
							 <div class="total">
								<span style="font-size: 13px;">{{\App\Helper\sepetHelper::totalPrice()}}</span> TL</div>
	...
	<!--start-logo-->
	<div class="logo">
		<a href="{{route('index')}}"><h1>Hazine Diyarı</h1></a>
	</div>
	<!--start-logo-->
	<!--bottom-header-->
							...
							<div class="mepanel">
								<div class="row">
									<div class="col1 me-one">
										<h4>Kitap</h4>
										<ul>
											<!--kategorileri navbarda yan yana getiriyor notelarda diğer kod var sonra değiştir-->
